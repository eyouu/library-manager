...
<body>
    <div class="container">
        ...
        <form:form action="${pageContext.request.contextPath}/librarian/saveLibrarian" modelAttribute="librarian" method="post">
            <form:hidden path="id" />
                ...
                <div class="form-inline">
                    <form:input cssClass="form-control mb-4 col-4 mr-2" placeholder="yyyy-dd-mm" path="registrationDate" />
