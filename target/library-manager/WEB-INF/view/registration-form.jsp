...
<body>
    <div class="container">
        ...
        <hr>
            ...
            <!-- Registration Form -->
            <form:form action="${pageContext.request.contextPath}/register/processRegistrationForm" modelAttribute="libraryUser">
                ...
                <!-- Confirm Password -->
                <div class="form-inline">
                    <form:password path="matchingPassword" placeholder="Confirm Password" cssClass="form-control mb-4 col-4 mr-2" />
                ...
                <div>
                    ...
                    <input class="btn btn-primary col-2" type="submit" value="Register" />
                </div>
            </form:form>
    </div>
