...
<div class="container">
    ...
    <ul class="list-group col-6">
        <li class="list-group-item active"><b>${book.id}. ${book.author} - ${book.title}</b></li>
        <li class="list-group-item bg-dark"></li>
        <c:forEach var="tempReader" items="${readers}">
            <li class="list-group-item">${tempReader.id}. ${tempReader.firstName} ${tempReader.lastName}</li>
            <li class="list-group-item bg-dark"></li>
        </c:forEach>
    </ul
