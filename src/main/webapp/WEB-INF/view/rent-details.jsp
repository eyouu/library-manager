    ...
    <div class="container">
        ...
        <hr>
            <ul class="list-group mb-2">
                <li class="list-group-item active"><b>Rent</b></li>
                <li class="list-group-item"><b>ID: </b>${rent.rentId}</li>
                <li class="list-group-item"><b>Status: </b>${rent.status}</li>
                <li class="list-group-item"><b>Date Of Rent: </b>${rent.dateOfRent}</li>
            </ul>
            <ul class="list-group mb-2">
                <li class="list-group-item active"><b>Book</b></li>
                <li class="list-group-item"><b>ID: </b>${book.id}</li>
            ...
            <ul class="list-group mb-4">
                <li class="list-group-item active"><b>Reader</b></li>
                <li class="list-group-item"><b>ID: </b> ${reader.id}</li>
                <li class="list-group-item"><b>Name: </b>${reader.firstName} ${reader.lastName}</li>
            </ul>
        <a class="btn btn-secondary col-2" href="${pageContext.request.contextPath}/rent/list">Back</a>
